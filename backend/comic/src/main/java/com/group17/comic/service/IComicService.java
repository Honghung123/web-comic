...
public interface IComicService {
       ...
       PageableData<Integer, List<LatestComic>> getComicsOfAnAuthor(UUID serverId, String authorId, String tagId, int page);
       SearchingPageableData<Integer, List<LatestComic>, List<AuthorResponse>> searchComic(UUID serverId,
       ...
       PageableData<?, ComicChapterContent> getComicChapterContent(UUID serverId,
                                                                   String tagId, String currentChapter);
       PageableData<?, ComicChapterContent> getComicChapterContentOnOtherServer(UUID serverId,
