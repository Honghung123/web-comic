...
@SpringBootTest
public class ComicServiceTestsWithTruyenFull extends ComicServiceTests {
    private final UUID pluginId = UUID.fromString("123e4567-e89b-12d3-a456-426614173002");

    @Test
    public void testValid_searchOnlyKeyword_ReturnList() {
        String keyword = "Tiên";
        ...
        assertThat(chapters.getMeta().size()).isNotEqualTo(0);
    }
    @Test
    public void testValid_searchOnlyByGenre_ReturnList() {
        String genre = "do-thi";
    ...
    @Test
    public void testValid_searchByKeywordAndGenre_ReturnList() {
    ...
    @Test
    public void testInvalid_searchComic_ReturnException() {
