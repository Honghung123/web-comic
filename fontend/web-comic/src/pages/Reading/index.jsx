...
const serverUrl = "http://localhost:8080/api/v1/comic";
...
export default function Reading() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://localhost:8080/api/v1/comic/download?converter_id=2`;
        try {
